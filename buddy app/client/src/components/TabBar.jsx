    ...
    <div className={styles.tabBar}>
      ...
      <NavLink to={ROUTES.shows} activeClassName={styles.active}>
        <img
          ...
          width="62"
          height="27"
          src={`./assets/icons/voorstellingen_icon.png`}
          alt={`chat icoon`}
        />
        {/* <svg
          xmlns="http://www.w3.org/2000/svg"
