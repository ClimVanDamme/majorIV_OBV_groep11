...
const TabBar = () => {
  return (
	...
	c-0.3,0-0.5-0.2-0.5-0.5l0-21.9l0.5-0.9"
          />
          <path
            className={styles.st2_1}
            d="M21.9,4.3c0,0-1.6,4.7,2.4,10.2c0.2,0.3,0.2,0.7,0.1,1c-1.3,3.9-1,8.9-0.5,10.2c0.1,0.2,0.3,0.3,0.5,0.3h3
	c0.3,0,0.5-0.2,0.5-0.5L27.7,3.6l-0.4-0.9"
          />
          <path
            className={styles.st3_1}
            d="M24.4,1c0,0-18.2-0.3-20.6,0S1.3,2.8,1.3,2.8s11.5,4.4,26,0C27.3,2.8,27,1.1,24.4,1z"
          />
          <path className={styles.st2} d="M4.8,14.8c0,0-1.7,1.2-4,0.2" />
          <path className={styles.st2} d="M23.8,15.2c0,0,1.7,1.2,4,0.2" />
        </svg>
      </NavLink>
    </div>
  );
